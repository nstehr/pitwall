...
func buildTerminator(ctx context.Context, client *dagger.Client, project *dagger.Directory, platform dagger.Platform) error {
	...
	path := "dist"
	builder = builder.WithExec([]string{"go", "build", "-o", "dist/terminator"})
