...
// Modifications copyright (C) 2022 Nathan Stehr
...
func newFirecrackerOptions() *firecrackerOptions {
...
func (opts *firecrackerOptions) getFirecrackerConfig() (firecracker.Config, error) {
...
func (opts *firecrackerOptions) getNetwork() ([]firecracker.NetworkInterface, error) {
...
func (opts *firecrackerOptions) getBlockDevices() ([]models.Drive, error) {
...
func (opts *firecrackerOptions) handleFifos() (io.Writer, error) {
...
func (opts *firecrackerOptions) addCloser(c func() error) {
	opts.closers = append(opts.closers, c)
}

func (opts *firecrackerOptions) Close() {
