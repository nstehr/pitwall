module github.com/nstehr/pitwall/cli
...
require (
	...
	github.com/openziti/channel/v2 v2.0.30 // indirect
	...
	github.com/openziti/sdk-golang v0.18.31 // indirect
	github.com/openziti/transport/v2 v2.0.53 // indirect
